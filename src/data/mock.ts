...
export const mockProjects: Project[] = [
  {
    ...
    short_description: 'Hududiy yoshlar bilan til mashg‘ulotlarini tashkil etishda ko‘maklashing.',
    description: 'Bir hafta davomida yoshlar uchun amaliy ingliz tili mashg‘ulotlari, speaking club va motivatsion uchrashuvlar tashkil etiladi. Volontyorlar ro‘yxatdan o‘tish, ishtirokchilarni yo‘naltirish va kontent tayyorlashda yordam beradi.',
    ...
    applicants_count: 17,
    points: 30,
    requirements: 'Mas’uliyat, o‘zbek va ingliz tilida muloqot qila olish, jamoa bilan ishlash.',
    status: 'PUBLISHED',
    is_premium_only: false,
    tags: ['Ta’lim', 'Ingliz tili', 'Offline'],
    questions: [
      { id: 1, text: 'Nega ushbu loyihada qatnashmoqchisiz?', answer_type: 'TEXTAREA', is_required: true, order: 1 },
      { id: 2, text: 'Ingliz tili darajangiz?', answer_type: 'SELECT', choices: ['A2', 'B1', 'B2', 'C1'], is_required: true, order: 2 }
    ]
  },
  {
    id: 2,
    ...
    short_description: 'Maktab o‘quvchilariga sun’iy intellektdan to‘g‘ri foydalanishni tushuntiring.',
    description: 'Volontyorlar maktablarda AI xavfsizligi, prompt yozish va ta’limda AI vositalaridan oqilona foydalanish bo‘yicha seminarlar o‘tkazadi.',
  ...
  },
  {
    ...
    short_description: 'Mahallalarda kitobxonlik uchrashuvlarini tashkillashtirishga yordam bering.',
    description: 'Kitob muhokamalari, mualliflar bilan uchrashuvlar va yosh kitobxonlar klublarini yo‘lga qo‘yishga qaratilgan loyiha.',
  ...
  },
  {
    ...
    short_description: 'Daraxt ekish va ekologik targ‘ibot aksiyasida faol qatnashing.',
    description: 'Shahar hududida ko‘chat ekish, chiqindilarni saralash bo‘yicha targ‘ibot va ekologik trening.',
  ...
  },
  {
    ...
    short_description: 'Forum mehmonlarini kutib olish va sessiyalarni boshqarishda yordam bering.',
    description: 'Viloyat yosh liderlari uchun ikki kunlik forum. Volontyorlar registratsiya, yo‘naltirish va spikerlar bilan ishlaydi.',
  ...
  },
  {
    ...
    short_description: 'Keksalarga davlat xizmatlaridan onlayn foydalanishni o‘rgating.',
    description: 'Volontyorlar mahallalarda keksalar va fuqarolarga my.gov.uz hamda boshqa raqamli xizmatlardan foydalanishda ko‘mak beradi.',
    ...
    applicants_count: 8,
    points: 40,
    requirements: 'Kompyuter va smartfondan yaxshi foydalana olish, sabr-toqat.',
    status: 'PUBLISHED',
    is_premium_only: true,
